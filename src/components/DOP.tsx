  ...
  const people: People[] = [
    {
      ...
      lname: "Anderson",
      title: "M.D., FAAO",
      bio: `Dr. Anderson is a leading eye surgeon with expertise in the latest surgical and medical ${(
        <a href='/treatments'>treatments</a>
      )} for eye disease including treatment for: Cataracts, Glaucoma, Macular Degeneration and Diabetes.
...
Dr. Anderson is Board Certified as a member of the American Academy of Ophthalmology. In his free time he enjoys his family, scuba diving, skiing and cycling.`,
    },
    {
      ...
      lname: "Christian",
      title: "O.D.",
      bio: `Dr. Duncan practices surgical and medical ophthalmology in our practice. With expertise in the latest medical and surgical ${(
        <a href='/treatments'>treatments</a>
      )} for eye diseases including: Cataracts, Glaucoma, Macular Degeneration, Diabetes and Pediatric Strabismus surgery.
...
Joseph is a Certified Optician with an expertise in providing you with the correct prescription and the correct frames for all ages. He is a Certified Optician with an expertise in providing you with the correct prescription and the correct frames for all ages.`,
    },
    {
      ...
      lname: "Olson",
      title: "O.D., MBA",
      bio: `Dr. Olson retired from the U.S. Army after a 30-year distinguished career, achieving the rank of Colonel. He and his wife, Valarie, have returned to their roots by coming home to Southern Utah.
